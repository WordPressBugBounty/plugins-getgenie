(() => {
  ...
  // assets/src/admin/js/oxygen-builder.js
  var scriptHandler = new ScriptHandler();
  jQuery(document).ready(function($) {
    MutationObserver = window.MutationObserver || window.WebKitMutationObserver;
    var observer = new MutationObserver(function(mutations, observer2) {
      for (let mutation of mutations) {
        if (mutation.target.className?.includes("ct-active")) {
          scriptHandler.oxygenScriptHandler.init(parent.document.getElementById("oxygen-sidebar"));
        } else if (mutation.target.className?.includes("oxygen-tinymce-dialog-wrap")) {
          scriptHandler.oxygenScriptHandler.init(parent.document.querySelector(".oxygen-tinymce-dialog-wrap"));
        } else if (mutation.target.className?.includes("html-active")) {
          scriptHandler.oxygenScriptHandler.init(parent.document.querySelector(".oxygen-tinymce-dialog-wrap"));
        } else if (mutation.target.className?.includes("tmce-active")) {
          scriptHandler.oxygenScriptHandler.init(parent.document.querySelector(".oxygen-tinymce-dialog-wrap"));
        }
      }
    });
    ...
    scriptHandler.oxygenScriptHandler.clickHandler();
  });
})();
