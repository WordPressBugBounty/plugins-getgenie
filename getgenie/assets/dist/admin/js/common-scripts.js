(() => {
  ...
  __export(Libs_exports, {
    BlurElement: () => BlurElement_default,
  ...
  var GenieSelect = ComposeComponents(({ options, setInput, sidebar: sidebar4, getInputs, except = [], disableList = [], name = "", defaultValue = "", label = "", placeholder = "", className = "", handleOnChange = () => "", onSearch = () => {
  }, ...props }) => {
    let list = options;
  ...
  var GenieTextarea = ComposeComponents2(({ name = "", setInput, sidebar: sidebar4, getInputs, className = "", label = "", defaultValue = "", errorMessage = "", ...props }) => {
  ...
  var GenieCard = ComposeComponents3(({ list, children, column = 1, handleClick, sidebar: sidebar4, setSidebar, skeleton: Skeleton3 = null, showActiveItem = false, loading = false, value = "", ...props }) => {
  ...
  var DrawerFooter = ComposeComponents4(({ prevScreen = true, nextScreen = true, enableNextBtn = false, handleNext = () => "", handlePrev = () => "", insertBtn = "", sidebar: sidebar4 }) => {
    return /* @__PURE__ */ React.createElement("div", {
  ...
  var GenieAiPopover = ({ children, placement = "top", title = "", content = "", isVisible = false, ...props }) => {
  ...
  var GenieInput = ComposeComponents5(({ name, sidebar: sidebar4, setInput, getInputs, autoComplete = "off", className = "", defaultValue = "", label = "", required = false, errorMessage = "", ...props }) => {
  ...
  var GenieTitleMsg = ({ loading, title, list }) => {
    const { Text } = Typography;
    return /* @__PURE__ */ React.createElement(React.Fragment, null, loading ? /* @__PURE__ */ React.createElement(Text, {
      className: "generateMsg"
    }, sidebar.__("Generating", "getgenie"), " ", title, " ", " ", /* @__PURE__ */ React.createElement(Text, {
      className: "resultNumber"
    }, "....")) : list.length > 0 && (title === "title" ? /* @__PURE__ */ React.createElement(Text, {
      className: "generateMsg"
    }, /* @__PURE__ */ React.createElement(Tooltip3, {
      title: sidebar.__("Select a title and click next", "getgenie"),
      placement: "top"
    }, sidebar.__("Generated", "getgenie"), " ", title, " ", "   "), /* @__PURE__ */ React.createElement("span", {
      className: "resultNumber"
    }, list.length)) : title === "intro" ? /* @__PURE__ */ React.createElement(Text, {
      className: "generateMsg"
    }, /* @__PURE__ */ React.createElement(Tooltip3, {
      title: sidebar.__("Select an intro and click next", "getgenie"),
      placement: "top"
    }, sidebar.__("Generated", "getgenie"), " ", title, " ", "   "), /* @__PURE__ */ React.createElement("span", {
      className: "resultNumber"
    }, list.length)) : title === "outline" ? /* @__PURE__ */ React.createElement(Text, {
      className: "generateMsg"
    }, /* @__PURE__ */ React.createElement(Tooltip3, {
      title: sidebar.__("Edit or delete the existing headings. Also you can add more headings to the outline. Finally, click Insert.", "getgenie"),
      placement: "top"
    }, sidebar.__("Selected", "getgenie"), " ", title, " ", "   "), /* @__PURE__ */ React.createElement("span", {
      className: "resultNumber"
    }, list.length)) : /* @__PURE__ */ React.createElement(Text, {
      className: "generateMsg"
    }, sidebar.__("Generated", "getgenie"), " ", title, " ", "   ", /* @__PURE__ */ React.createElement("span", {
      className: "resultNumber"
    }, list.length))));
  };
  var TitleMsg_default = GenieTitleMsg;
  ...
  var DrawerHeader = ComposeComponents6(({ sidebar: sidebar4, setSidebar, getInputs, setInput, screenName = "" }) => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      alt: "logo"
    }), "SEO ", seoEnabled ? sidebar4.__("Enabled", "getgenie") : sidebar4.__("Disabled", "getgenie")) : /* @__PURE__ */ React.createElement("div", {
  ...
  var ConfirmModal = (title = "", content = "", onYes = () => "", onCancel = () => "") => {
    const sidebar4 = wp.data.select("getgenie").sidebar();
    Modal3.confirm({
      title,
  ...
  var DrawerWrapper = ComposeComponents8(({ children, sidebar: sidebar4, setSidebar, getInputs }) => {
    const [drawerWidth, setDrawerWidth] = useState4(width.main);
    const { open, generatedOutlines, analyzeKeyword } = sidebar4;
    const headToHead = getInputs["headTohead"] || false;
    let mask = true;
    if (window.getGenie.config.wizardScreen === "post" && sidebar4.component === "ScoreAnalysis") {
      mask = false;
    }
    if (sidebar4.component === "GenieChat") {
      width.main = 430;
    } else {
    ...
    useEffect6(() => {
      ...
      if (sidebar4.paragraphEditorScreen.open && analyzeKeyword.open) {
    ...
    }, [sidebar4.analyzeKeyword.open, sidebar4.generatedOutlines.open, sidebar4.paragraphEditorScreen.open, headToHead]);
    useEffect6(() => {
      const getDocumentBody = document.querySelector("body");
      const rootContainer = sidebar4.rootContainer;
  ...
  var GenieNumberInput = ComposeComponents9(({ name, setInput, getInputs, sidebar: sidebar4, handleOnChange = () => "", defaultValue = 1, max = null, label = "", placeholder = "", type = "text", required = false, errorMessage = "", className = "", ...props }) => {
    let updatedValue = getInputs[name] || defaultValue;
    const handleChange = (value) => {
      if (isNaN(value)) {
        return;
  ...
  var GenieSlider = ComposeComponents10(({ label, name, setInput, getInputs, sidebar: sidebar4, defaultValue, message, handleOnChange = () => "", className = "", ...props }) => {
  ...
  var GenieNavbar = ({ tabPaneList = [], handleActiveKey = () => "", activeKey = "", destroyInactiveTabPane = true, className = "", ...props }) => {
    return /* @__PURE__ */ React.createElement("div", {
      className: `getgenie-navbar ${className}`
  ...
  var BlurElement_default = BlurElement;
  ...
  var ContentFeedback = ComposeComponents12(({ content, listName, getInputs, setInput, creativityLevel, input, sidebar: sidebar4, contentType = "" }) => {
    const handleFeedback = (type, text) => {
      ...
      let data = {
        ...
        feedback_type: type,
        template_name: contentType || sidebar4.currentTemplate || "unknown",
        request_hash: sidebar4.requestId
      };
      HandleFetch((res) => {
  ...
  var ContentFeedback_default = ContentFeedback;
  ...
  var CompetitorAnalyzer = class {
    constructor(ContentAnalysis, KeywordFinder2, GenieHelpers2) {
      this.ContentAnalysis = ContentAnalysis;
      this.KeywordFinder = KeywordFinder2;
      this.GenieHelpers = GenieHelpers2;
    }
    getDomainName(url) {
      try {
        const parsedUrl = new URL(url);
  ...
  var MainContentSidebar = ComposeComponents13(({ sidebar: sidebar4, setSidebar, setInput, getInputs }) => {
  ...
  var LicenseNotice = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      className: "getgenie-license-alert",
      style: { padding: "10px" }
    }, /* @__PURE__ */ React.createElement(Alert, {
      style: { borderRadius: "2px", padding: "15px" },
      message: /* @__PURE__ */ React.createElement("a", {
        style: { color: "#357ab5", fontWeight: 500 },
        href: `${window.getGenie.config?.siteUrl}/wp-admin/admin.php?page=getgenie#license`
      }, sidebar2.__("Please activate your license", "getgenie")),
      type: "warning",
      showIcon: true
    }));
  };
  var LicenseNotice_default = LicenseNotice;
  ...
  var PromotionalNotice = ComposeComponents16(({ getInputs, type = "", names = [], showIcon = true, color = "#263e87", backgroundColor = "#bffdff", sidebar: sidebar4 }) => {
    const [message, setMessage] = useState8(null);
    useEffect11(() => {
      if (type == "promotionalNotice") {
        const wordUses = sidebar4.subscriptionStatistics.usagePercentage?.word_generate;
    ...
    }, [sidebar4.subscriptionStatistics.usagePercentage]);
    const handleClose = () => {
      const date = new Date();
  ...
  var PromotionalNotice_default = PromotionalNotice;
  ...
  var GenieChat = ComposeComponents17(({ sidebar: sidebar4, getInputs, setInput }) => {
    ...
    const handleResponse = (chatData) => {
      ...
      const payLoad = {
        chatPersonality: getInputs["chatPersonality"] || sidebar4.chatPersonality,
        maxToken: getInputs["maxToken"] || sidebar4.maxToken,
        messages
      };
      setIsFetching(true);
      HandleFetch5((res) => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      src: genieChat2,
      alt: "genie-chat"
    }), /* @__PURE__ */ React.createElement("h5", null, sidebar4.__("Welcome to ", "getgenie"), " Genie ", sidebar4.__("Chat", "getgenie")), /* @__PURE__ */ React.createElement("p", null, sidebar4.__("All you have to do is ask or instruct your Genie to kick off the ", "getgenie"), " AI ", sidebar4.__("magic!", "getgenie"), " ")), /* @__PURE__ */ React.createElement("div", {
      ...
      label: /* @__PURE__ */ React.createElement(React.Fragment, null, sidebar4.__("Chat Personality", "getgenie"), /* @__PURE__ */ React.createElement(Libs6.Tooltip, {
        title: sidebar4.__("Choose who you want to chat with", "getgenie"),
        placement: "top"
      })),
      options: Static_default.chatCharacters,
      defaultValue: sidebar4.chatPersonality
    })), /* @__PURE__ */ React.createElement(Col5, {
      span: 12
    }, /* @__PURE__ */ React.createElement(Libs6.Select, {
      name: "maxToken",
      className: "maxToken-field",
      label: /* @__PURE__ */ React.createElement(React.Fragment, null, sidebar4.__("Size", "getgenie"), /* @__PURE__ */ React.createElement(Libs6.Tooltip, {
        title: sidebar4.__("Define the size of the content", "getgenie"),
        placement: "top"
      })),
      options: Static_default.maxToken,
      defaultValue: sidebar4.maxToken
    }))), /* @__PURE__ */ React.createElement("div", {
  ...
  window.getGenie.Components = {
    ...window.getGenie.Components,
    Common: {
      ...window.getGenie.Components.Common || {},
      Libs: Libs_exports,
      Utilities: Utilities_exports,
      LicenseNotice: LicenseNotice_default,
      ContentFeedback: ContentFeedback_default,
      StaticData: Static_default,
      PromotionalNotice: PromotionalNotice_default
    }
  };
})();
